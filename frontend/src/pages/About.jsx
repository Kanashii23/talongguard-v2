...
// ── Update with real team member names ────────────────────────────────
const TEAM = [
    ...
    <div className="page-enter">
      ...
      <section className="bg-white border-b border-gray-100 py-20 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-display text-5xl font-bold text-forest-950 mb-4">About TalongGuard</h1>
          <p className="text-gray-500 text-lg leading-relaxed max-w-xl mx-auto">
            TalongGuard: An Intelligent Eggplant Disease Diagnostic Rover Equipped with Portable Imaging System — a thesis project combining autonomous robotics, computer vision, and AI to detect and map eggplant leaf diseases in real time.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            {[
              ...
              <div key={label} className="flex items-center gap-2 bg-gray-50 border border-gray-100 px-4 py-2 rounded-full text-sm text-gray-600 font-medium">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <p className="text-forest-600 text-sm font-semibold uppercase tracking-widest mb-3">The People</p>
          <h2 className="font-display text-4xl font-bold text-forest-950">Meet the Team</h2>
          <p className="text-gray-400 text-sm mt-3">The minds behind TalongGuard</p>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {TEAM.map(({ name, role, initial }) => (
            <div key={name} className="bg-white rounded-3xl p-7 text-center border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
        ...
        <p className="text-center text-gray-400 text-xs mt-5">
          📌 Update <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs">frontend/src/pages/About.jsx</code> with real team names and roles
        </p>
      </section>
      ...
      <section className="bg-white border-t border-gray-100 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-forest-600 text-sm font-semibold uppercase tracking-widest mb-3">Under the Hood</p>
            <h2 className="font-display text-4xl font-bold text-forest-950">Technology Stack</h2>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {TECH.map(({ icon, name, desc }) => (
              <div key={name} className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
                <div className="text-3xl flex-shrink-0">{icon}</div>
                <div>
                  <div className="font-semibold text-gray-800 text-sm leading-tight mb-1">{name}</div>
