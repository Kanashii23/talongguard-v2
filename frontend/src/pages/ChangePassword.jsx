            ...
            {success ? (
              ...
              <>
                <div className="text-center mb-8">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-2xl mx-auto mb-4 shadow-md">
                    🔐
                  </div>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-5 flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-amber-700 text-xs mt-0.5">
                        You must change your temporary password before using TalongGuard.
                      </p>
                    </div>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-1.5">
                      Use uppercase, numbers & symbols for a strong password
                    </p>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2">
                    ...
                    <input
                      ...
                      className={`w-full border rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 bg-gray-50 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 transition-all ${
