            ...
            {sent ? (
              <div className="text-center py-4 animate-fade-up">
                ...
                <p className="text-gray-500 text-sm leading-relaxed mb-6">
                  If an account exists for <strong className="text-gray-800">{email}</strong>, we've sent a password reset link. Check your inbox and spam folder.
                </p>
                <Link to="/login" className="text-forest-600 hover:text-forest-800 text-sm font-medium transition">
                  ← Back to Login
                </Link>
              </div>
            ) : (
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-400 text-sm mt-2">Enter your email and we'll send a reset link.</p>
                </div>
