        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          ...
          <div className="p-8 sm:p-10">
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-forest-700 to-eggplant-700 flex items-center justify-center text-3xl mx-auto mb-5 shadow-lg">🍆</div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex justify-end mt-1.5">
                  <Link to="/forgot-password" className="text-xs text-forest-600 hover:text-forest-800 font-medium transition">Forgot password?</Link>
                </div>
              </div>
            ...
            <p className="text-center text-xs text-gray-400 mt-6">🔒 Access is managed by the System Administrator</p>
          </div>
        </div>
        <p className="text-center text-xs text-gray-400 mt-5">Don't have an account? Contact your administrator.</p>
      </div>
    </div>
  )
}